fetch('json/images.json').then(function(response) {
  response.json().then(function(json) {
	...
	hCaption.innerText = "This is a colors palette catalog. You can choose the color of the car you want to hire from here. (Some colors are currently not available!)";
